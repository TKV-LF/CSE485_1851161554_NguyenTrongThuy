                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-2">
                                    <button type="button" class="btn btn-success float-right" data-toggle="modal"
                                        data-target=".bd-example-modal-lg">Add new video <i
                                    ...
                                    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="action/addVideo.php?&name=<?php echo $userName; ?>" method="POST" class="mx-5 px-5">
                                                    <div class="wrap-input100 validate-input"
                                                        data-validate="Please type">
                                                        <input type="text" size="40" name="category"
                                                            class="form-control input100" value=""
                                                    ...
                                                    <div class="wrap-input100 validate-input"
                                                        data-validate="Please type">
                                                        <input type="text" size="40" name="embed"
                                                            class="form-control input100" value="" placeholder="Embed">
                                                        <span class="focus-input100"></span>
                                                        <span class="symbol-input100">
                                                        </span>
                                                    </div>
                                                    <div class="wrap-input100 validate-input"
                                                        ...
                                                        <input type="text" size="40" name="title"
                                                            class="form-control input100" value="" placeholder="Title">
                                                        <span class="focus-input100"></span>
                                                        <span class="symbol-input100">
                                                        </span>
                                                    </div>
                                                    <div class="wrap-input100 validate-input"
                                                        data-validate="Please type">
                                                        <input type="text" size="40" name="thumbnail"
                                                            class="form-control input100" value=""
                                                    ...
                                                    <div class="container-login100-form-btn">
                                                        <input type="submit"
                                                            class="btn btn-primary login100-form-btn mb-5"
                                                            value="Create">
                                                    </div>
                                                </form>
                                            </div>
                            ...
                            <table class="table table-bordered ">
                                        ...
                                        <th>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    style="margin-top:-80% !important;" name="" id="allCheck"
                                                    value="checkedValue">
                                            </div>
                                        </th>
                                        <th>No</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input box" name="" id=""
                                                    value="checkedValue">
                                            </div>
                                        </td>
                                        ...
                                        function confirm_delete() {
                                            if (confirm("Are you sure delete?") === true) {
                                                $(".delete").attr("href", "action/delete.php?id=<?php echo $row['0'] ?>&name=<?php echo $userName; ?>");
                                            } else {
                                                $(".delete").attr("href", "#");
                                            }
                                        }
