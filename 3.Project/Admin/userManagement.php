    ...
    ?>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a type="button" class="" data-toggle="modal" data-target="#modelId">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title text-center">View</h5>
                              </div>
                              <div class="modal-body">
                                <div class="row">
                                  ...
                                  <div class="col-8 mt-2">
                                    <input class="w-100" disabled class="pl-3" value="<?php echo $row['2']; ?>"
                                      type="text" name="email" placeholder="" />
                                  </div>
                                  <div class="col-4 mt-2">
                                    <p>Last Name</p>
                                  ...
                                  <div class="col-8 mt-2">
                                    <input class="w-100" disabled class="pl-3" value="<?php echo $row['3']; ?>"
                                      type="text" name="email" placeholder="" />
                                  </div>
                                  <div class="col-4 mt-2">
                                    <p>Email</p>
                                  ...
                                  <div class="col-8 mt-2">
                                    <input class="w-100" disabled class="pl-3" value="<?php echo $row['4']; ?>"
                                      type="text" name="email" placeholder="" />
                                  </div>
                                  <div class="col-4 mt-2">
                                    <p>Role</p>
                                  ...
                                  <div class="col-8 mt-2">
                                    <input class="w-100" disabled class="pl-3" value="<?php echo $row['5']; ?>"
                                      type="text" name="email" placeholder="" />
                                  </div>
              ...
              <td>
                <a href="action/changeUser.php?id=<?php echo $row['0']; ?>&name=<?php echo $userName; ?>"><i
                    class="fa fa-pencil mr-2"></i></a>
              </td>
              <td>
                <a href="action/userDelete.php?id=<?php echo $row['0']; ?>&name=<?php echo $userName; ?>"
